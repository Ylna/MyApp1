...
public class Main12Act9_2 extends AppCompatActivity {
    private ArrayList category;
    private HashMap product;//key表示类别，value表示多个商品
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout18_9_2);
        initData();
    ...
    class MyAdapter extends BaseExpandableListAdapter{
        ...
        public int getChildrenCount(int i) {
            ...
            ArrayList prolist=(ArrayList) product.get(cat);//得到商品
            return prolist.size();
        }
        ...
        public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
           //得到二级数据的视图
            ...
            imageView.setImageResource(R.drawable.bizhi);
            return view;
        }
