...
import static cn.edu.sdwu.android.classroom.sn170507180210.R.styleable.View;

public class Main7Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b){
                    Toast.makeText(Main7Act.this,"on",Toast.LENGTH_SHORT).show();

                }else {
                    Toast.makeText(Main7Act.this,"off",Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> adapterView, android.view.View view, int i, long l) {
                ...
                Toast.makeText(Main7Act.this,content,Toast.LENGTH_SHORT).show();
            }
